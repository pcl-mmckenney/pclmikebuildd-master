        ...
        <div id="qfb-wrap-outer">
            ...
            <div id="qfb-wrap" class="qfb-cf">
                <div id="qfb-control-panel">
                    ...
                    <div class="qfb-control-panel-right-icons">
                        ...
                        <div id="qfb-preview-hide" title="<?php esc_attr_e('Hide preview', 'quform'); ?>"><i class="fa fa-eye-slash"></i></div>
                        <div id="qfb-preview-only" title="<?php esc_attr_e('Show preview only', 'quform'); ?>"><i class="fa fa-eye"></i></div>
                        <div id="qfb-save-form" class="qfb-animated-save-button" title="<?php esc_attr_e('Save', 'quform'); ?>"><i class="fa fa-floppy-o"></i></div>
                    </div>
                </div>
                            ...
                            <div class="qfb-tabs-panel" id="qfb-settings">
                                <div id="qfb-form-settings-tabs">
                                    <ul class="qfb-tabs-nav qfb-cf">
                                        ...
                                        <li><a><i class="fa fa-database"></i><?php esc_html_e('Database', 'quform'); ?></a></li>
                                    </ul>
                                    ...
                                    <div class="qfb-tabs-panel">
                                        ...
                                        <div id="qfb-form-style-tabs">
                                            ...
                                            <ul class="qfb-tabs-nav qfb-sub-tabs-nav qfb-cf">
                                                <li><a><i class="fa fa-globe"></i><?php esc_html_e('Global', 'quform'); ?></a></li>
                                                <li><a><i class="mdi mdi-label_outline"></i><?php esc_html_e('Labels', 'quform'); ?></a></li>
                                                <li><a><i class="fa fa-pencil"></i><?php esc_html_e('Fields', 'quform'); ?></a></li>
                                                <li><a><i class="fa fa-hand-pointer-o"></i><?php esc_html_e('Buttons', 'quform'); ?></a></li>
                                                <li><a><i class="mdi mdi-compare_arrows"></i><?php esc_html_e('Pages', 'quform'); ?></a></li>
                                                <li><a><i class="fa fa-spinner"></i><?php esc_html_e('Loading', 'quform'); ?></a></li>
                                            ...
                                            <div class="qfb-tabs-panel">
                                                ...
                                                <div class="qfb-settings">
                                                    ...
                                                    <div class="qfb-settings-heading qfb-settings-heading-light-right"><?php esc_html_e('Global styles', 'quform'); ?><i class="fa fa-globe"></i></div>
                                                    ...
                                                    <div class="qfb-setting">
                                                        <div class="qfb-setting-label">
                                                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php printf(esc_html__('Enter a value using any CSS unit, for example: %s', 'quform'), '<code>10px</code>'); ?></div></div>
                                            ...
                                            <div class="qfb-tabs-panel">
                                                ...
                                                <div class="qfb-settings">
                                                    ...
                                                    <div class="qfb-settings-heading qfb-settings-heading-light-right"><?php esc_html_e('Fields', 'quform'); ?><i class="fa fa-pencil"></i></div>
                                            ...
                                            <div class="qfb-tabs-panel">
                                                ...
                                                <div class="qfb-settings">
                                                    ...
                                                    <div class="qfb-settings-heading qfb-settings-heading-light-right"><?php esc_html_e('Buttons', 'quform'); ?><i class="fa fa-hand-pointer-o"></i></div>
                                            ...
                                            <div class="qfb-tabs-panel">
                                                ...
                                                <div class="qfb-settings">
                                                    ...
                                                    <div class="qfb-settings-heading qfb-settings-heading-light-right"><?php esc_html_e('Loading', 'quform'); ?><i class="fa fa-spinner"></i></div>
                                            ...
                                            <div class="qfb-tabs-panel">
                                                ...
                                                <div class="qfb-settings">
                                                    ...
                                                    <div class="qfb-setting<?php echo $builder->getFormConfigValue($form, 'tooltipsEnabled') ? '' : ' qfb-hidden'; ?>">
                                                        <div class="qfb-setting-label">
                                                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php printf(esc_html__('If set to %1$sField%2$s, the tooltip will show when the user interacts with the field. If set to %1$sIcon%2$s, the tooltip will be shown when the user interacts with an icon.', 'quform'), '<span class="qfb-bold">', '</span>'); ?></div></div>
                                            ...
                                            <div class="qfb-setting">
                                                ...
                                                <div class="qfb-setting-inner">
                                                    <div class="qfb-setting-input">
                                                        ...
                                                        <p class="qfb-description"><?php printf(esc_html__('Sets the default format for dates and times when displayed in the form. See %sthis page%s for more information about custom formats. If empty, the formats will be inherited from the options at Forms &rarr; Settings &rarr; Global &rarr; Date & time format (JS).', 'quform'), '<a href="https://docs.telerik.com/kendo-ui/framework/globalization/dateformatting#custom" target="_blank">', '</a>'); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="qfb-setting">
                                                ...
                                                <div class="qfb-setting-inner">
                                                    <div class="qfb-setting-input">
                                                        ...
                                                        <p class="qfb-description"><?php printf(esc_html__('Sets the default format for dates and times when displayed in notification emails and when viewing entries. See %sthis page%s for more information about custom formats. If empty, the formats will be inherited from the options at Forms &rarr; Settings &rarr; Global &rarr; Date & time format (PHP).', 'quform'), '<a href="https://codex.wordpress.org/Formatting_Date_and_Time" target="_blank">', '</a>'); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="qfb-tabs-panel">
                                        ...
                                        <div class="qfb-settings">
                                            ...
                                            <div class="qfb-settings-heading"><i class="fa fa-database"></i><?php esc_html_e('Custom database settings (MySQL)', 'quform'); ?></div>
                                            ...
                                            <div class="qfb-settings-heading"><i class="fa fa-floppy-o"></i><?php esc_html_e('What to save', 'quform'); ?></div>
                    ...
                    <div class="qfb-icon-selector">
                        ...
                        <div class="qfb-icon-selector-icons qfb-cf">
                            <?php foreach ($builder->getQuformIcons() as $icon) : ?>
                                <div class="qfb-icon-selector-icon" data-icon="<?php echo esc_attr($icon); ?>" title="<?php echo esc_attr(ucfirst(str_replace(array('-', '_'), ' ', preg_replace('/^qicon\-/', '', $icon)))); ?>">
                                    <span class="<?php echo esc_attr('fa ' . $icon); ?>"></span>
                                </div>
                            <?php endforeach; ?>
                            <?php foreach ($builder->getFontAwesomeIcons() as $icon) : ?>
                                <div class="qfb-icon-selector-icon" data-icon="fa <?php echo esc_attr($icon); ?>" title="<?php echo esc_attr(ucfirst(str_replace('-', ' ', preg_replace('/^fa\-/', '', $icon)))); ?>">
                                    <span class="<?php echo esc_attr('fa ' . $icon); ?>"></span>
                                </div>
                            <?php endforeach; ?>
                        </div>
            ...
            <div id="qfb-add-to-website-popup" class="qfb-popup">
                ...
                <div class="qfb-popup-content">
                    ...
                    <div class="qfb-settings">
                        ...
                        <div class="qfb-settings-heading"><i class="fa fa-code"></i> <?php esc_html_e('Shortcode', 'quform'); ?></div>
                        ...
                        <div class="qfb-settings-heading"><i class="fa fa-bars"></i> <?php esc_html_e('Widget', 'quform'); ?></div>
                        ...
                        <div class="qfb-settings-heading"><i class="fa fa-file-code-o"></i> <?php esc_html_e('PHP', 'quform'); ?></div>
            ...
            <div id="qfb-bulk-options" class="qfb-popup">
                <div class="qfb-popup-content">
                    ...
                    <div class="qfb-settings-heading"><i class="fa fa-archive"></i> <?php esc_html_e('Add bulk options', 'quform'); ?></div>
