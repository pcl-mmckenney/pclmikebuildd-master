        ...
        <div class="qfb-tabs-panel">
            <div class="qfb-element-settings-inner">
                ...
                <div class="qfb-settings">
                    ...
                    <div class="qfb-setting">
                        <div class="qfb-setting-label">
                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php esc_html_e('These are the choices that the user will be able to choose from.', 'quform'); ?><br><br><?php printf(esc_html__('The %sCustomize values%s setting allows you to have a different value being submitted than the value that is displayed to the user.', 'quform'), '<span class="qfb-bold">', '</span>'); ?></div></div>
                        ...
                        <div class="qfb-setting-inner qfb-options">
                            <div class="qfb-setting-input">
                                ...
                                <div class="qfb-customise-values-wrap">
                                    <label><?php esc_html_e('Customize values', 'quform'); ?><span class="qfb-tooltip"><i class="fa fa-question"></i><span class="qfb-tooltip-content"><?php esc_html_e('If enabled, the submitted option value can be different from the option label.', 'quform'); ?></span></span></label>
                                ...
                                <div class="qfb-options-right-buttons">
                                    ...
                                    <div id="qfb-add-optgroup-button" class="qfb-button"><i class="fa fa-list-alt"></i>  <?php esc_html_e('Add optgroup', 'quform'); ?></div>
                                    <div id="qfb-add-bulk-options-button" class="qfb-button"><i class="fa fa-archive"></i>  <?php esc_html_e('Add bulk options', 'quform'); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="qfb-setting-input">
                                <div id="qfb-name-tabs">
                                    ...
                                    <div class="qfb-tabs-panel">
                                        ...
                                        <div class="qfb-sub-setting">
                                            <div class="qfb-sub-setting-label">
                                                <label for="qfb_name_prefix_none_option"><?php esc_html_e('"Please select" option', 'quform'); ?><span class="qfb-tooltip"><i class="fa fa-question"></i><span class="qfb-tooltip-content"><?php esc_html_e('Adds an option to the top of the list to let the user choose no value. The text can be changed on the Translations tab.', 'quform'); ?></span></span></label>
                                            </div>
                                            <div class="qfb-sub-setting-inner">
                                                <div class="qfb-sub-setting-input">
                    ...
                    <div class="qfb-setting">
                        <div class="qfb-setting-label">
                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php printf(esc_html__('Enter a value using any CSS unit, for example: %s', 'quform'), '<code>600px</code>'); ?></div></div>
        ...
        <div class="qfb-tabs-panel">
            ...
            <div class="qfb-element-settings-inner">
                ...
                <div class="qfb-settings">
                            ...
                            <div class="qfb-setting-input">
                                <select id="qfb_options_layout">
                                    ...
                                    <?php foreach (range(2, 20) as $i) : ?>
                                        <option value="<?php echo esc_attr($i); ?>"><?php echo esc_html(sprintf(_n('%s column', '%s columns', $i, 'quform'), number_format_i18n($i))); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="qfb-setting">
                        <div class="qfb-setting-label">
                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php printf(esc_html__('Sets the height of the field, enter a number to show that number of options at one time. Enter %sauto%s to set the height to show all options.', 'quform'), '<code>', '</code>'); ?></div></div>
        ...
        <div class="qfb-tabs-panel">
            <div class="qfb-element-settings-inner">
                ...
                <div class="qfb-settings">
                    ...
                    <div class="qfb-setting">
                        <div class="qfb-setting-label">
                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php printf(esc_html__('The tooltip text will appear next to your element in a tooltip when the user hovers it with their mouse. You can customize the look of tooltips by going to %1$sSettings &rarr; Style &rarr; Tooltips%2$s', 'quform'), '<span class="qfb-bold">', '</span>'); ?></div></div>
                    ...
                    <div class="qfb-setting">
                        <div class="qfb-setting-label">
                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php printf(esc_html__('If set to %1$sInherit%2$s, the setting will be inherited from the global form settings. If set to %1$sField%2$s, the tooltip will show when the user interacts with the field. If set to %1$sIcon%2$s, the tooltip will be shown when the user interacts with an icon.', 'quform'), '<span class="qfb-bold">', '</span>'); ?></div></div>
                    ...
                    <div class="qfb-setting">
                        <div class="qfb-setting-label">
                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php printf(esc_html__('If set to %1$sInherit%2$s, the setting will be inherited from the global form settings.', 'quform'), '<span class="qfb-bold">', '</span>'); ?></div></div>
                    ...
                    <div class="qfb-setting">
                        <div class="qfb-setting-label">
                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php printf(esc_html__('Specify the width of the label, any valid CSS width is accepted, e.g. %s.', 'quform'), '<code>200px</code>'); ?></div></div>
        ...
        <div class="qfb-tabs-panel">
            ...
            <div class="qfb-element-settings-inner">
                ...
                <div class="qfb-settings">
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php echo esc_html_e('Enter the value in the format YYYY-MM-DD, enter {today} to use the current date.', 'quform'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="qfb-setting">
                        <div class="qfb-setting-label">
                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php printf(esc_html__('This is the name of the parameter that you will use to set the default. For example, in the URL you can set the value using %s.', 'quform'), '<span class="qfb-bold">?parameter_name=my_value</span>'); ?></div></div>
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description">
                                    <?php printf(esc_html__('Enter the file extension excluding the dots and separated by commas e.g. %s.', 'quform'), '<code>jpg, jpeg, png, gif</code>'); ?>
                                    <br><br>
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php esc_html_e('Enter the maximum size of a file in MB.', 'quform'); ?> <a href="http://support.themecatcher.net/quform-wordpress-v2/basics/elements/file-upload#maximum-allowed-file-size" target="_blank"><?php esc_html_e('Important information', 'quform'); ?></a>.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php printf(esc_html__('The format of the date when displayed in notifications and when viewing entries. See %sthis page%s for how to set a custom date format. If empty, the format will be inherited from the option at Edit Form &rarr; Settings &rarr; Language &rarr; Date & time format (PHP) &rarr; Date.', 'quform'), '<a href="https://codex.wordpress.org/Formatting_Date_and_Time" target="_blank">', '</a>'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php printf(esc_html__('The format of the time when displayed in the form. See %sthis page%s for how to set a custom time format. If empty, the format will be inherited from the option at Edit Form &rarr; Settings &rarr; Language &rarr; Date & time format (JS) &rarr; Time.', 'quform'), '<a href="https://docs.telerik.com/kendo-ui/framework/globalization/dateformatting#custom" target="_blank">', '</a>'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php printf(esc_html__('The format of the time when displayed in notifications and when viewing entries. See %sthis page%s for how to set a custom time format. If empty, the format will be inherited from the option at Edit Form &rarr; Settings &rarr; Language &rarr; Date & time format (PHP) &rarr; Time.', 'quform'), '<a href="https://codex.wordpress.org/Formatting_Date_and_Time" target="_blank">', '</a>'); ?></p>
                            </div>
                        </div>
                    </div>
