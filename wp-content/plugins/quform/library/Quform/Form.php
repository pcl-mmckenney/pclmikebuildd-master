...
class Quform_Form
{
    ...
    public function getPageProgressHtml()
    {
        ...
        if ($type == 'numbers' || $type == 'percentage') {
            ...
            if ($type == 'numbers') {
                /*
                 * translators: Page x of x
                 * %1$s - the current page number
                 * %2$s - the total number of pages
                 */
                $output .= sprintf(
                ...
                /*
                 * translators: page progress percentage
                 * %s - the page progress percentage
                 * %% - the percentage sign
                 */
                $output .= sprintf(
                    esc_html__('%s%%', 'quform'),
...
%1$s .quform-group-style-bordered > .quform-child-elements',
            ...
            'optionLabel' => '%1$s .quform-option .quform-option-label',
            'optionLabelSelected' => '%1$s .quform-option .quform-field:checked + .quform-option-label',
            ...
            'groupElements' => '%s .quform-element-group > .quform-child-elements',
