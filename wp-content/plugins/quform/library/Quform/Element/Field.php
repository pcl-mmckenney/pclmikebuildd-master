...
abstract class Quform_Element_Field extends Quform_Element
{
    ...
    /**
     * The ID of the element that this belongs to
     * @var string
     */
    protected $belongsTo;
    ...
    /**
     * Set the name of the parent element to which this one belongs to
     *
     * @param   string  $name
     * @return  $this
     */
    ...
    protected function getCssSelectors()
    {
        return array(
            ...
            'elementTextFocus' => '%s .quform-field-%s:focus, %s .quform-field-%s:active',
            'elementTextarea' => '%s .quform-field-%s',
            'elementTextareaHover' => '%s .quform-field-%s:hover',
            'elementTextareaFocus' => '%s .quform-field-%s:focus, %s .quform-field-%s:active',
            'elementSelect' => '%s .quform-field-%s',
            'elementSelectHover' => '%s .quform-field-%s:hover',
            'elementSelectFocus' => '%s .quform-field-%s:focus, %s .quform-field-%s:active',
