                    ...
                    <div class="qfb-sub-setting">
                        ...
                        <div class="qfb-sub-setting-inner">
                            <div class="qfb-sub-setting-input">
                                ...
                                <p class="qfb-description"><?php printf(esc_html__('JSON encoded options to pass to the popup script, %sexamples%s.', 'quform'), '<a href="http://support.themecatcher.net/quform-wordpress-v2/guides/customization/popup-script-options" target="_blank">', '</a>'); ?></p>
                            </div>
                        </div>
                    </div>
