...
class Quform_Admin_Page_Entries_Edit extends Quform_Admin_Page_Entries
{
    ...
    protected function enqueueScripts()
    {
        ...
        wp_enqueue_script('jquery-form', Quform::url('js/jquery.form.min.js'), array('jquery'), '4.2.2', true);
    ...
    {
        $extra[10] = sprintf(
            '<div class="qfb-nav-item"><a class="qfb-nav-item-link" href="%s"><i class="fa fa-arrow-left"></i></a></div>',
