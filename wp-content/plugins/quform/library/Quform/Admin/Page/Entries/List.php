...
class Quform_Admin_Page_Entries_List extends Quform_Admin_Page_Entries
{
    ...
    public function getEntryLabelEditHtml(array $label = null)
    {
        ...
        $output .= sprintf('<span class="qfb-entry-label-edit-name" title="%s">%s</span>', esc_attr__('Click to edit name', 'quform'), Quform::escape($label['name']));
        ...
        $output .= '<span class="qfb-entry-label-edit-action-remove"><i class="fa fa-trash"></i></span>';
        $output .= '</div></div>';
