...
abstract class Quform_Admin_Page
{
    ...
    {
        wp_enqueue_style('font-awesome-quform', Quform::url('css/font-awesome.min.css'), array(), '4.7.0');
    ...
    public function getNavHtml(array $currentForm = null, array $extra = array())
    {
        ...
        <div id="qfb-nav" class="qfb-cf">
            ...
            <div class="qfb-nav-item qfb-nav-item-right qfb-nav-item-help">
                ...
                <div class="qfb-nav-popup-content">
                    <ul class="qfb-nav-menu qfb-cf">
                        <li class="qfb-cf"><a href="http://support.themecatcher.net/" target="_blank"><i class="fa fa-life-ring"></i><?php esc_html_e('Visit help site', 'quform'); ?></a></li>
                        <li class="qfb-cf"><a href="http://support.themecatcher.net/quform-wordpress-v2" target="_blank"><i class="fa fa-book"></i><?php esc_html_e('View documentation', 'quform'); ?></a></li>
                        <li class="qfb-cf"><a href="http://support.themecatcher.net/forums/" target="_blank"><i class="fa fa-comments"></i><?php esc_html_e('Support forum', 'quform'); ?></a></li>
                        <li class="qfb-cf"><a href="https://www.youtube.com/channel/UCoyKi9_M7ECFYK-w7ZqNMVg" target="_blank"><i class="fa fa-play"></i><?php esc_html_e('Video tutorials', 'quform'); ?></a></li>
                    </ul>
                </div>
