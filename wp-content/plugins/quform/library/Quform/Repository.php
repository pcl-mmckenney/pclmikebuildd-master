...
class Quform_Repository
{
    ...
    public function getFormsById(array $ids)
    {
        ...
        $sql = "SELECT * FROM " . $this->getFormsTableName() . " WHERE id IN ($ids)";
    ...
    public function activateForms(array $ids)
    {
        ...
        $sql = "UPDATE " . $this->getFormsTableName() . " SET active = 1 WHERE id IN ($ids)";
    ...
    public function deactivateForms(array $ids)
    {
        ...
        $sql = "UPDATE " . $this->getFormsTableName() . " SET active = 0 WHERE id IN ($ids)";
    ...
    public function trashForms(array $ids)
    {
        ...
        $sql = "UPDATE " . $this->getFormsTableName() . " SET trashed = 1 WHERE id IN ($ids)";
    ...
    public function untrashForms(array $ids)
    {
        ...
        $sql = "UPDATE " . $this->getFormsTableName() . " SET trashed = 0 WHERE id IN ($ids)";
    ...
    public function deleteForms(array $ids)
    {
        ...
        $wpdb->query("DELETE FROM " . $this->getEntryEntryLabelsTableName() . " WHERE entry_id IN (SELECT id FROM " . $this->getEntriesTableName() . " WHERE form_id IN ($ids))");

        // Delete entry labels
        $wpdb->query("DELETE FROM " . $this->getEntryLabelsTableName() . " WHERE form_id IN ($ids)");

        // Delete entry data
        $wpdb->query("DELETE FROM " . $this->getEntryDataTableName() . " WHERE entry_id IN (SELECT id FROM " . $this->getEntriesTableName() . " WHERE form_id IN ($ids))");

        // Delete entries
        $wpdb->query("DELETE FROM " . $this->getEntriesTableName() . " WHERE form_id IN ($ids)");

        // Delete the forms
        $affectedRows = (int) $wpdb->query("DELETE FROM " . $this->getFormsTableName() . " WHERE id IN ($ids)");
...
GROUP BY entries.id";
    ...
    public function setFormEntryLabels($formId, array $labels)
    {
        ...
        if ($ids == '') {
            ...
            $wpdb->query($sql = $wpdb->prepare(
                "DELETE el, eel FROM `" . $this->getEntryLabelsTableName() . "` el LEFT JOIN `" . $this->getEntryEntryLabelsTableName() . "` eel ON el.id = eel.entry_label_id WHERE el.form_id = %d AND el.id NOT IN ($ids)",
                $formId
            ));
        }
...
AND `ed`.`value` = '%s'";
    ...
    public function readEntries(array $ids)
    {
        ...
        $sql = "UPDATE " . $this->getEntriesTableName() . " SET unread = 0 WHERE id IN ($ids)";
    ...
    public function unreadEntries(array $ids)
    {
        ...
        $sql = "UPDATE " . $this->getEntriesTableName() . " SET unread = 1 WHERE id IN ($ids)";
    ...
    public function trashEntries(array $ids)
    {
        ...
        $sql = "UPDATE " . $this->getEntriesTableName() . " SET status = 'trash' WHERE id IN ($ids)";
    ...
    public function untrashEntries(array $ids)
    {
        ...
        $sql = "UPDATE " . $this->getEntriesTableName() . " SET status = 'normal' WHERE id IN ($ids)";
    ...
    public function deleteEntries(array $ids)
    {
        ...
        // Delete entry label association
        $wpdb->query("DELETE FROM " . $this->getEntryEntryLabelsTableName() . " WHERE entry_id IN ($ids)");

        // Delete entry data
        $wpdb->query("DELETE FROM " . $this->getEntryDataTableName() . " WHERE entry_id IN ($ids)");

        // Delete the entries
        $affectedRows = (int) $wpdb->query("DELETE FROM " . $this->getEntriesTableName() . " WHERE id IN ($ids)");
...
WHERE `entries`.`form_id` = %d AND `entries`.`status` = 'normal'", $form->getId());
    ...
    public function uninstall()
    {
        ...
        $wpdb->query("DROP TABLE IF EXISTS " . $this->getFormsTableName());
        $wpdb->query("DROP TABLE IF EXISTS " . $this->getEntriesTableName());
        $wpdb->query("DROP TABLE IF EXISTS " . $this->getEntryDataTableName());
        $wpdb->query("DROP TABLE IF EXISTS " . $this->getEntryLabelsTableName());
        $wpdb->query("DROP TABLE IF EXISTS " . $this->getEntryEntryLabelsTableName());
