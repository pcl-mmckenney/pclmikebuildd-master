...
class Quform_Validator_FileUpload extends Quform_Validator_Abstract
{
    ...
    public static function getMessageTemplates($key = null)
    {
        $messageTemplates = array(
            ...
            self::NUM_REQUIRED => __('Please upload at least %min% file(s)', 'quform'),
            self::TOO_MANY => __('You cannot upload more than %max% file(s)', 'quform'),
            self::TOO_BIG_FILENAME => __("File '%filename%' exceeds the maximum allowed file size", 'quform'),
            self::TOO_BIG => __('File exceeds the maximum allowed file size', 'quform'),
            self::NOT_ALLOWED_TYPE_FILENAME => __("File type of '%filename%' is not allowed", 'quform'),
            self::NOT_ALLOWED_TYPE => __('File type is not allowed', 'quform'),
            self::NOT_UPLOADED_FILENAME => __("File '%filename%' is not an uploaded file", 'quform'),
            self::NOT_UPLOADED => __('File is not an uploaded file', 'quform'),
            self::ONLY_PARTIAL_FILENAME => __("File '%filename%' was only partially uploaded", 'quform'),
