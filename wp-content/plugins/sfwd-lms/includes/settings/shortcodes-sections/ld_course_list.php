		...
		function init_shortcodes_section_fields() {
			$this->shortcodes_option_fields = array(
				...
				'mycourses' => array(
					...
					'value' 		=> 	'',
					'options'		=>	array(
											''				=>	sprintf( _x('Show All %s (default)', 'placeholders: courses', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'Courses' ) ),
											'enrolled'		=>	sprintf( _x('Show Enrolled %s only', 'placeholders: courses', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'Courses' ) ),
											'not-enrolled'	=>	sprintf( _x('Show not-Enrolled %s only', 'placeholders: courses', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'Courses' ) ),
										)
				),
			);
