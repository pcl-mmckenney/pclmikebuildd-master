		...
		function init_shortcodes_section_fields() {
			$this->shortcodes_option_fields = array(
				...
				'expand_all' => array(
					...
					'name'  		=> 	'expand_all', 
					'type'  		=> 	'select',
					'label' 		=> 	sprintf( _x('Expand All %s Sections', 'placeholder: Course', 'learndash'), LearnDash_Custom_Label::get_label( 'course' ) ),
					'help_text'		=>	sprintf( _x('Expand All %s sections', 'placeholder: Course', 'learndash'), LearnDash_Custom_Label::get_label( 'course' ) ),
					'value' 		=> 	'no',
					'options'		=>	array(
											''		=>	__('No', 'learndash'),
