<?php
if ( ( class_exists( 'LearnDash_Settings_Section' ) ) && ( !class_exists( 'LearnDash_Settings_Section_Course_Builder_Submit' ) ) ) {
	class LearnDash_Settings_Section_Course_Builder_Submit extends LearnDash_Settings_Section {
...
add_action( 'learndash_settings_sections_init', function() {
	LearnDash_Settings_Section_Course_Builder_Submit::add_section_instance();
} );
