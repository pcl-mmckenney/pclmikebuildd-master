		...
		<div id="poststuff">
				...
				<div class="wrap">
					<table class="form-table">
						<tbody>
							<tr>
								<th scope="row">
									<?php echo sprintf( _x('Hide %s title', 'Hide quiz title', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								</th>
								<td>
									<fieldset>
										...
										<p class="description">
											<?php echo sprintf( _x('The title serves as %s heading.', 'The title serves as quiz heading.', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' )); ?>
										</p>
									</fieldset>
								</td>
							</tr>
							<tr>
								<th scope="row">
									<?php echo sprintf( _x('Hide "Restart %s" button', 'Hide "Restart quiz" button', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								</th>
								<td>
									<fieldset>
										<legend class="screen-reader-text">
											<span><?php echo sprintf( _x('Hide "Restart %s" button', 'Hide "Restart quiz" button', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?></span>
										</legend>
										...
										<p class="description">
											<?php echo sprintf( _x('Hide the "Restart %s" button in the Frontend.', 'Hide the "Restart quiz" button in the Frontend.', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
										</p>
									</fieldset>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<fieldset>
										...
										<p class="description">
											<?php _e('Also works in conjunction with the "display randomly question" option.', 'wp-pro-quiz'); ?>
										</p>
									</fieldset>
								</td>
							</tr>
							...
							<tr>
								<th scope="row">
									<?php echo sprintf( _x('Protect %s Answers in Browser Cookie', 'Protect Quiz Answers in Browser Cookie', 'wp-pro-quiz'), LearnDash_Custom_Label::get_label( 'quiz' ) ); ?>
								</th>
								<td>
									<fieldset>
										<legend class="screen-reader-text">
											<span><?php echo sprintf( _x('Use cookies for %s Answers', 'Use cookies for Quiz Answers', 'wp-pro-quiz'), LearnDash_Custom_Label::get_label( 'quiz' ) ); ?></span>
										</legend>
										<label for="time_limit_cookie">
											<input type="number" min="0" class="small-text" id="time_limit_cookie" value="<?php echo intval($this->quiz->getTimeLimitCookie()); ?>" name="timeLimitCookie"> <?php _e('Seconds', 'wp-pro-quiz'); ?>
										</label>
										<p class="description">
											<?php echo sprintf( _x("0 = Don't save answers. This option will save the user's answers into a browser cookie until the %s is submitted.", 'placeholders: Quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::get_label( 'quiz' ) ); ?>
										</p>
									</fieldset>
								</td>
							</tr>
							<tr>
								...
								<td>
									<fieldset>
										...
										<p class="description">
											<?php echo sprintf( _x('Statistics about right or wrong answers. Statistics will be saved by completed %s, not after every question. The statistics is only visible over administration menu. (internal statistics)', 'placeholders: quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
										</p>
									</fieldset>
								</td>
							</tr>
							...
							<tr id="statistics_show_profile_tr" style="display: none;">
								<th scope="row">
									<?php _e('View Profile Statistics', 'wp-pro-quiz'); ?>
								</th>
								<td>
									<fieldset>
										<legend class="screen-reader-text">
											<span><?php _e('View Profile Statistics', 'wp-pro-quiz'); ?></span>
										</legend>
										<label for="statistics_on">
										...
										<p class="description">
											<?php echo sprintf( _x('Enable user to view statistics for this %s on their profile.', 'placeholders: quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
										</p>
									</fieldset>
								</td>
							</tr>
							...
							<tr>
								<th scope="row">
									<?php echo sprintf( _x('Execute %s only once', 'Execute quiz only once', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								</th>
								<td>
									<fieldset>
									
										<legend class="screen-reader-text">
											<span><?php echo sprintf( _x('Execute %s only once', 'Execute quiz only once', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?></span>
										</legend>
										...
										<p class="description">
											<?php echo sprintf( _x('If you activate this option, the user can complete the %s only once. Afterwards the %s is blocked for this user.', 'placeholders: quiz, quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
										</p>
							...
							<tr>
								...
								<td>
									<fieldset>
										...
										<p class="description">
											<?php echo sprintf( _x('If you enable this option, you can choose %s, which user have to finish before he can start this %s.', 'placeholders: quiz, quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
										</p>
										<p class="description">
											<?php echo sprintf( _x('In all selected %s statistic function have to be active. If it is not it will be activated automatically.', 'placeholders: quizzes', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quizzes' ) ); ?>
										</p>
										<div id="prerequisiteBox" style="display: none;">
											<table>
												<tr>
													<th style="width: 120px; padding: 0;"><?php echo sprintf( _x('%s', 'Quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::get_label( 'course' ) ); ?></th>
													<th style="padding: 0; width: 50px;"></th>
													<th style="padding: 0; width: 400px;"><?php echo sprintf( _x('Prerequisites (This %s has to be finished)', 'Prerequisites (This quiz has to be finished)', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?></th>
												</tr>
												<tr>
													<td style="padding: 0;">
							...
							<tr>
								...
								<td>
									<fieldset>
										...
										<p class="description">
											<?php echo sprintf( _x('Additional %s overview will be displayed, before %s is finished.', 'placeholders: quiz, quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ), LearnDash_Custom_Label::label_to_lower( 'quiz' )); ?>
										</p>
										...
										<div class="wpProQuiz_demoBox">
											<?php echo sprintf( _x( '%s-summary', 'Quiz-summary', 'wp-pro-quiz' ), LearnDash_Custom_Label::get_label( 'quiz' ) ); ?>: <a href="#"><?php _e('Demo', 'wp-pro-quiz'); ?></a> 
											<div style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
							...
							<tr class="wpProQuiz_reviewQuestionOptions" style="display: none;">
								<th scope="row">
									<?php echo sprintf( _x( '%s-summary', 'Quiz-summary', 'wp-pro-quiz' ), LearnDash_Custom_Label::get_label( 'quiz' ) ); ?>
								</th>
								<td>
									<fieldset>
										<legend class="screen-reader-text">
											<span><?php echo sprintf( _x( '%s-summary', 'Quiz-summary', 'wp-pro-quiz' ), LearnDash_Custom_Label::get_label( 'quiz' ) ); ?></span>
										</legend>
										<label>
										...
										<p class="description">
											<?php echo sprintf( _x('If you enable this option, no %s overview will be displayed, before finishing %s.', 'placeholders: quiz, quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
										</p>
									</fieldset>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<fieldset>
										...
										<p class="description">
											<?php echo sprintf( _x('If you enable this option, you will be informed if a user completes this %s.', 'placeholders: quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
										</p>
										<p class="description">
							...
							<tr>
								...
								<td>
									<fieldset>
										...
										<p class="description">
											<?php echo sprintf( _x('If you enable this option, an email is sent with his %s result to the user. (only registered users)', 'placeholders: quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'course' ) ); ?>
										</p>
										<p class="description">
											<?php _e('E-Mail settings can be edited in global settings.', 'wp-pro-quiz'); ?>
										</p>
							...
							<tr>
								...
								<td>
									<fieldset>
										...
										<p class="description">
											<?php echo sprintf( _x('If you enable this option, the %s will start automatically after the page is loaded.', 'placeholders: quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
										</p>
									</fieldset>
								</td>
							</tr>
							<tr>
								<th scope="row">
									<?php echo sprintf( _x('Only registered users are allowed to start the %s', 'placeholders: quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								</th>
								<td>
									<fieldset>
										<legend class="screen-reader-text">
											<span><?php echo sprintf( _x('Only registered users are allowed to start the %s', 'placeholders: quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?></span>
										</legend>
										<label>
										...
										<p class="description">
											<?php echo sprintf( _x('If you enable this option, only registered users allowed start the %s.', 'placeholders: quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
										</p>
									</fieldset>
								</td>
							</tr>
			...
			*/
			...
			<div class="postbox">
				...
				<div class="inside">
					<p class="description">
						<?php echo sprintf( _x('This text will be displayed at the end of the %s (in results). (this text is optional)', 'placeholders: quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
					</p>
					...
					<div style="display: none;" id="resultGrade">
						<div>
							...
							<ul style="list-style-type: square; padding: 5px; margin-left: 20px; margin-top: 0;">
								...
								<li>
									<?php echo sprintf( _x('Percentages refer to the total score of the %s. (Current total %d points in %d questions.', 'placeholders: quiz, question points, question count', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ), $this->quiz->fetchSumQuestionPoints(), $this->quiz->fetchCountQuestions()); ?>
									</li>
				...
				<div class="wrap">
					<table class="form-table">
						<tbody>
							...
							<tr>
								<th scope="row">
									<?php echo sprintf( _x('Hide %s time - display', 'Hide quiz time - display', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								</th>
								<td>
									<fieldset>
										<legend class="screen-reader-text">
											<span><?php echo sprintf( _x('Hide %s time - display', 'Hide quiz time - display', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?></span>
										</legend>
										<label>
										...
										<p class="description">
											<?php echo sprintf( _x('If you enable this option, the time for finishing the %s won\'t be displayed on the results page anymore.', 'placeholders: quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
										</p>
									</fieldset>
...
<?php 
							...
							<tr>
								...
								<td>
									<fieldset>
										...
										<p class="description">
											<?php echo sprintf( _x('Shows in %s, how many points are reachable for respective question.', 'placeholders: quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' )); ?>
										</p>
									</fieldset>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<fieldset>
										...
										<p class="description">
											<?php _e('If you enable this option, category will be displayed in the question.', 'wp-pro-quiz'); ?>
										</p>
										<div class="wpProQuiz_demoBox">
											<a href="#"><?php _e('Demo', 'wp-pro-quiz'); ?></a> 
											<div style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
				...
				<table class="form-table">
					<tbody id="toplistBox">
						...
						<tr id="AutomaticallyDisplayLeaderboard">
							<th scope="row">
								<?php echo sprintf( _x('Automatically display leaderboard in %s result', 'Automatically display leaderboard in quiz result', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' )); ?>
							</th>
							<td>
	...
	?>
		<div class="postbox">
				<h3 class="hndle"><?php echo sprintf( _x('%s-Mode', 'Quiz-Mode', 'wp-pro-quiz'), LearnDash_Custom_Label::get_label( 'quiz' ) ); ?> <?php _e('(required)', 'wp-pro-quiz'); ?></h3>
				<div class="inside">
					<table style="width: 100%; border-collapse: collapse; border: 1px solid #A0A0A0;" class="wpProQuiz_quizModus">
						...
						<tbody>
							...
							<tr>
								<td>
									<?php echo sprintf( _x('Displays all questions sequentially, "right" or "false" will be displayed at the end of the %s.', 'placeholders: quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								</td>
								<td>
    ...
    private function form() {
        ...
        <div class="postbox">
				...
				<div class="inside">
					...
					<p class="description">
						<?php _e('You can create custom fields, e.g. to request the name or the e-mail address of the users.', 'wp-pro-quiz'); ?>
					</p>
					<p class="description">
								...
								<td>
									<fieldset>
										...
										<label>
											...
											<?php echo sprintf( _x('On the %s startpage', 'On the quiz startpage', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
										...
										<label>
											...
											<?php echo sprintf( _x('At the end of the %s (before the %s result)', 'At the end of the quiz (before the quiz result)', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
					...
					<div style="margin-top: 10px; padding: 10px; border: 1px solid #C2C2C2;">
								...
								<tr <?php echo $index++ == 0 ? 'style="display: none;"' : '' ?>>
									...
									<td style="position: relative;">
										<select name="form[][type]">
											<option value="<?php echo WpProQuiz_Model_Form::FORM_TYPE_TEXT; ?>" <?php echo $checkType[0]; ?>><?php _e('Text', 'wp-pro-quiz'); ?></option>
											<option value="<?php echo WpProQuiz_Model_Form::FORM_TYPE_TEXTAREA; ?>" <?php echo $checkType[1]; ?>><?php _e('Textarea', 'wp-pro-quiz'); ?></option>
											<option value="<?php echo WpProQuiz_Model_Form::FORM_TYPE_CHECKBOX; ?>" <?php echo $checkType[2]; ?>><?php _e('Checkbox', 'wp-pro-quiz'); ?></option>
											<option value="<?php echo WpProQuiz_Model_Form::FORM_TYPE_SELECT; ?>" <?php echo $checkType[3]; ?>><?php _e('Drop-Down menu', 'wp-pro-quiz'); ?></option>
											<option value="<?php echo WpProQuiz_Model_Form::FORM_TYPE_RADIO; ?>" <?php echo $checkType[4]; ?>><?php _e('Radio', 'wp-pro-quiz'); ?></option>
											<option value="<?php echo WpProQuiz_Model_Form::FORM_TYPE_NUMBER; ?>" <?php echo $checkType[5]; ?>><?php _e('Number', 'wp-pro-quiz'); ?></option>
											<option value="<?php echo WpProQuiz_Model_Form::FORM_TYPE_EMAIL; ?>" <?php echo $checkType[6]; ?>><?php _e('Email', 'wp-pro-quiz'); ?></option>
											<option value="<?php echo WpProQuiz_Model_Form::FORM_TYPE_YES_NO; ?>" <?php echo $checkType[7]; ?>><?php _e('Yes/No', 'wp-pro-quiz'); ?></option>
											<option value="<?php echo WpProQuiz_Model_Form::FORM_TYPE_DATE; ?>" <?php echo $checkType[8]; ?>><?php _e('Date', 'wp-pro-quiz'); ?></option>
										</select>
										...
										<div class="dropDownEditBox" style="position: absolute; border: 1px solid #AFAFAF; background: #EBEBEB; padding: 5px; bottom: 0;right: 0;box-shadow: 1px 1px 1px 1px #AFAFAF; display: none;">
											...
											<input type="button" value="<?php _e('OK', 'wp-pro-quiz'); ?>" class="button-primary">
										</div>
									</td>
									<td>
									...
									<td>
										...
										<a class="form_move button-secondary" href="#" style="cursor:move;"><?php _e('Move', 'wp-pro-quiz'); ?></a>
						...
						<div style="margin-top: 10px;">
							<input type="button" name="form_add" id="form_add" value="<?php _e('Add field', 'wp-pro-quiz'); ?>" class="button-secondary">
						</div>
					</div>
				</div>
			</div>
